...
Note also that previous standalone multi-XPU scripts can be found in the [scripts/standalone_scripts/ParallelRandomFields_multixpu](scripts/standalone_scripts/ParallelRandomFields_multixpu) directory.
