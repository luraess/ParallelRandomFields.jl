...
@views function generate_grf3D(;cov_typ="expon", do_viz=true, do_save=false,
                                lx=100.0, ly=100.0, lz=100.0, sf=1.0, cl=(10.0, 8.0, 5.0), k_m=100.0, nh=10000,
                                nx=64, ny=64, nz=64)
    # Derived numerics
    ...
    elseif cov_typ=="gauss"
        ...
        grf3D_gauss!(Yf, sf, cl[1]/2.0, nh, k_m, nx, ny, nz, dx, dy, dz; do_reset=true)
    else
